...
//		CharStream in = new CharSequenceCharStream(buffer, endOffset, "<unknown>");
		CharStream in = new ANTLRStringStream(buffer.toString());
...
//
//		return existing;
		return 0;	// From: https://upsource.jetbrains.com/idea-ce/file/idea-ce-e97504227f5f68c58cd623c8f317a134b6d440b5/java/java-psi-impl/src/com/intellij/lang/java/lexer/JavaLexer.java
	}

	@Override
	public int getTokenStart() {
//		return currentToken.getStartIndex();
		return currentToken.getTokenIndex();
	}

	@Override
	public int getTokenEnd() {
//		return currentToken.getStopIndex() + 1;
		return currentToken.getTokenIndex() + currentToken.getText().length();
	}
