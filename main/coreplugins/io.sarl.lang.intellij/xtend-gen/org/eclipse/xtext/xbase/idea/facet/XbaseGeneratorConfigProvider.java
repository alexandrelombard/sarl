...
public class XbaseGeneratorConfigProvider implements IGeneratorConfigProvider {
  ...
  public GeneratorConfig get(final EObject context) {
    final com.intellij.openapi.module.Module module = ModuleProvider.findModule(context.eResource().getResourceSet());
    if ((module != null)) {
  ...
  protected JavaVersion getTargetJavaVersion(final XbaseGeneratorConfigurationState state, final com.intellij.openapi.module.Module module) {
      ...
      if (languageLevel != null) {
        switch (languageLevel) {
          ...
          case JDK_1_8:
            ...
            break;
          case JDK_1_9:
            _switchResult = JavaVersion.JAVA9;
            break;
          default:
            _switchResult = JavaVersion.JAVA8;
            break;
