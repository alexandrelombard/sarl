  ...
  public ProjectDescription getProjectDescription(final Object module) {
    if ((module instanceof com.intellij.openapi.module.Module)) {
      ...
      final Procedure1<ProjectDescription> _function = (ProjectDescription it) -> {
        it.setName(((com.intellij.openapi.module.Module)module).getName());
        final OrderEntry[] enumerator = ModuleRootManager.getInstance(((com.intellij.openapi.module.Module)module)).getOrderEntries();
