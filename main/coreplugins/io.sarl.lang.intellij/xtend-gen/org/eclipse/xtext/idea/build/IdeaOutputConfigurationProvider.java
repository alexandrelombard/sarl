...
public class IdeaOutputConfigurationProvider implements IContextualOutputConfigurationProvider, IContextualOutputConfigurationProvider2 {
  ...
  public Set<OutputConfiguration> getOutputConfigurations(final ResourceSet context) {
    ...
    if ((module instanceof com.intellij.openapi.module.Module)) {
      return this.getOutputConfigurations(((com.intellij.openapi.module.Module)module));
    }
    return this.defaultOutput.getOutputConfigurations();
  }
  
  public Set<OutputConfiguration> getOutputConfigurations(final com.intellij.openapi.module.Module module) {
  ...
  public String toModuleRelativePath(final String path, final com.intellij.openapi.module.Module module) {
