...
public class TraceBasedApplicationConfigurationProducer extends JavaRunConfigurationProducerBase<ApplicationConfiguration> {
  ...
  public boolean internalIsConfigurationFromContext(final ApplicationConfiguration appConfiguration, final ConfigurationContext context) {
    ...
    if (((aClass != null) && 
      Comparing.equal(JavaExecutionUtil.getRuntimeQualifiedName(aClass), appConfiguration.getMainClassName()))) {
      ...
      final com.intellij.openapi.module.Module configurationModule = appConfiguration.getConfigurationModule().getModule();
      boolean _equal = Comparing.<com.intellij.openapi.module.Module>equal(context.getModule(), configurationModule);
      if (_equal) {
        return true;
      }
      ...
      final com.intellij.openapi.module.Module predefinedModule = template.getConfigurationModule().getModule();
      boolean _equal_1 = Comparing.<com.intellij.openapi.module.Module>equal(predefinedModule, configurationModule);
      if (_equal_1) {
        return true;
      }
    }
