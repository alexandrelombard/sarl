...
public class IndexingAwareGlobalSearchScope extends GlobalSearchScope {
  public static class Factory {
    ...
    public IndexingAwareGlobalSearchScope createSearchScope(final XtextResourceSet resourceSet) {
      ...
      final com.intellij.openapi.module.Module context = ModuleProvider.findModule(resourceSet);
  ...
  @Override
  public boolean isSearchInModuleContent(final com.intellij.openapi.module.Module aModule) {
    boolean _xblockexpression = false;
    {
